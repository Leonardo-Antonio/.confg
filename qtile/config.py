...
def init_widgets_list():
    widgets_list = [
        ...
        widget.CurrentLayout(
            fmt="AudiChes",
            mouse_callbacks={'Button1': lambda: qtile.cmd_spawn(
                "/home/leo/.audiches/audiches-1.0.0/audiches &")},
            background="#000000",
            padding=15,
        ),
...
commads = [
    "feh --bg-fill ~/.config/qtile/wallpaper/wallpaper.png &> /dev/null &",
